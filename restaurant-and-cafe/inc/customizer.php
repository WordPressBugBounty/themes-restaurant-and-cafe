...
function restaurant_and_cafe_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_section(
        'restaurant_and_cafe_typography_section',
        array(
            'title' => __( 'Typography Settings', 'restaurant-and-cafe' ),
            'priority' => 80,
        )
    );
    ...
    $wp_customize->add_control(
        'ed_localgoogle_fonts',
        array(
            'label'   => __( 'Load Google Fonts Locally', 'restaurant-and-cafe' ),
            'section' => 'restaurant_and_cafe_typography_section',
            'type'    => 'checkbox',
        )
    );
    ...
    $wp_customize->add_control(
        'ed_preload_local_fonts',
        array(
            'label'           => __( 'Preload Local Fonts', 'restaurant-and-cafe' ),
            'section'         => 'restaurant_and_cafe_typography_section',
            'type'            => 'checkbox',
            'active_callback' => 'restaurant_and_cafe_flush_fonts_callback'
        )
    );
    ...
    $wp_customize->add_control(
        'flush_google_fonts',
        array(
            'label'       => __( 'Flush Local Fonts Cache', 'restaurant-and-cafe' ),
            'description' => __( 'Click the button to reset the local fonts cache.', 'restaurant-and-cafe' ),
            'type'        => 'button',
            'settings'    => array(),
            'section'     => 'restaurant_and_cafe_typography_section',
            'input_attrs' => array(
                'value' => __( 'Flush Local Fonts Cache', 'restaurant-and-cafe' ),
    ...
    $wp_customize->get_section( 'restaurant_and_cafe_typography_section' )->panel = 'wp_default_panel';
...
function restaurant_and_cafe_flush_fonts_callback( $control ){
